...
if typing.TYPE_CHECKING:
    ...
    legacy_producer = StompProducer(client=stompman.Client(servers=[]), serializer=None)
    native_producer = StompProducer(client=Runtime(RuntimeConfig(servers=())), serializer=None)
